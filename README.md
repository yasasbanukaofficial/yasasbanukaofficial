...
[email](mailto:yasasbanukagunasena@gmail.com)
...
<samp>next.js &nbsp; react &nbsp; typescript &nbsp; javascript &nbsp; python &nbsp; java &nbsp; flutter &nbsp; react native &nbsp; node.js &nbsp; spring boot &nbsp; fastapi &nbsp; express &nbsp; postgresql &nbsp; mongodb &nbsp; prisma &nbsp; pytorch &nbsp; pandas &nbsp; numpy &nbsp; docker &nbsp; git</samp>
...
Secrets aren't meant to be shared. Curo manages your secrets without leaking or<br>
sharing, across the platforms.

**[glassdoor-job-market-insights](https://github.com/yasasbanukaofficial/glassdoor-job-market-insights)** &nbsp;·&nbsp; <samp>python</samp><br>
Cleans and analyzes Glassdoor data science job postings to estimate salary trends<br>
based on required skills and company attributes.
